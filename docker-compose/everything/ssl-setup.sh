...
# This script helps you set up SSL certificates for n8n.zealautomations.cloud

set -e

echo "🔒 Let's Encrypt SSL Certificate Setup for n8n.zealautomations.cloud"
echo "===================================================================="
...
obtain_lets_encrypt() {
    ...
    sudo certbot certonly --standalone \
        ...
        --agree-tos \
        --no-eff-email \
        -d n8n.zealautomations.cloud
    
    # Verify certificates were obtained
    if [ ! -f /etc/letsencrypt/live/n8n.zealautomations.cloud/fullchain.pem ] || [ ! -f /etc/letsencrypt/live/n8n.zealautomations.cloud/privkey.pem ]; then
    ...
    sudo cp /etc/letsencrypt/live/n8n.zealautomations.cloud/fullchain.pem data/nginx/ssl/cert.pem
    sudo cp /etc/letsencrypt/live/n8n.zealautomations.cloud/privkey.pem data/nginx/ssl/key.pem
...
echo ""
echo "Access your n8n instance at: https://n8n.zealautomations.cloud" 